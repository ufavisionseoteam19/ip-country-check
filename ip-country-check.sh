#!/bin/bash
# ============================================================
# ip-country-check.sh  (v2 - เซฟไฟล์ เรียงตามประเทศ)
# ใส่เลข IP -> บอกประเทศ + ISP + เมือง
# เซฟผลเป็นไฟล์ เรียงตามประเทศ (ทับชื่อเดิม ไม่สร้างใหม่)
# รองรับ: ใส่ IP ตรงๆ (ทีละตัว/หลายตัว) หรืออ่านจากไฟล์
...
DELAY=1.4
OUTDIR="/root"
OUT="$OUTDIR/รายชื่อ.txt"                  # ไฟล์ผล (ทับชื่อเดิมทุกครั้ง)
TAB=$(printf '\t')                         # ตัวคั่น tab (portable)
# --------------------------------
